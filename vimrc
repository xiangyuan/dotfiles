...
fun! <SID>StripTrailingWhitespaces()
    ...
    call cursor(l, c)
endfun
autocmd FileType c,cpp,java,go,php,ruby,javascript,puppet,python,rust,twig,xml,yml,perl,lua autocmd BufWritePre <buffer> :call <SID>StripTrailingWhitespaces()
